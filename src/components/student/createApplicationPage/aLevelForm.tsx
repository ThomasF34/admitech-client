              ...
              <div style={{ padding: '2%' }}>
                ...
                <div className="row" style={{ padding: '5px' }}>
                  <div className="col">
                    ...
                    <h6 className='text-danger'>{this.props.errors.bac_name}</h6>
                  </div>
                  <div className="col">
                    <h6>Année : </h6>
                    ...
                    <h6 className='text-danger'>{this.props.errors.bac_year}</h6>
                  </div>
                </div>
                ...
                <div className="row" style={{ padding: '5px' }}>
                  <div className="col">
                    ...
                    <h6 className='text-danger'>{this.props.errors.bac_mention}</h6>
                  </div>
                  <div className="col">
                    ...
                    <h6 className='text-danger'>{this.props.errors.bac_realname}</h6>
                  </div>
                </div>
                ...
                <div className="row" style={{ padding: '5px' }}>
                  <div className="col">
                    ...
                    <h6 className='text-danger'>{this.props.errors.last_facility_name}</h6>
                  </div>
                </div>
                ...
                <div className="row" style={{ padding: '5px' }}>
                  <div className="col">
                    ...
                    <h6 className='text-danger'>{this.props.errors.last_facility_address}</h6>
                  </div>
                </div>
                ...
                <div className="row" style={{ padding: '5px' }}>
                  <div className="col">
                    ...
                    <h6 className='text-danger'>{this.props.errors.last_facility_postal_code}</h6>
                  </div>
                  <div className="col">
                    <h6>Ville : </h6>
                    ...
                    <h6 className='text-danger'>{this.props.errors.last_facility_city}</h6>
                  </div>
                  <div className="col">
                    <h6>Pays : </h6>
                    ...
                    <h6 className='text-danger'>{this.props.errors.last_facility_state}</h6>
                  </div>
                </div>
