              ...
              <div style={{ padding: '2%' }}>
                ...
                <div className="row" style={{ padding: '5px' }}>
                  ...
                  <div className="col">
                    ...
                    <select name="family_status" className="form-control" placeholder={this.props.values.family_status || "Sélectionner une valeur"} value={this.props.values.family_status} onChange={this.props.handleChange} disabled={!this.props.editMode}>
