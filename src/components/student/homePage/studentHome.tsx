      ...
      return (
        ...
        <div className="root fill ">
          <div className="row fill no-gutters">
            ...
            <div className="d-none d-md-block col-md-3 col-lg-2 shadow-lg fill" >
              {/* should deal here with burger menu when small*/}
              <StudentNav userImage={user} userName="Romain Planchet" />
            </div>

            <div className="col-sm-12 col-md-9 col-lg-10 fill">
              <div className="image-container">
                ...
                <div className="main-container align-items-end" >
                  ...
                  <div className="col-sm-12 col-md-12 fill-container no-gutters" style={{ paddingRight: '0%' }}>
